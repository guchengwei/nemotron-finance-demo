...
case "$PRESET" in
  ...
  local-vllm)
    ...
    echo
    echo "    # Use the tracked parser plugin bundled in this repo (requires vLLM >= 0.11.2):"
    echo "    test -f backend/vllm_plugins/nemotron_nano_v2_reasoning_parser.py"
    echo
    ...
    echo "      --reasoning-parser-plugin backend/vllm_plugins/nemotron_nano_v2_reasoning_parser.py \\"
